...
simu.simMechanicsFile = 'RM3_PT_Tether.slx';      % Specify Simulink Model File
...
pto(1).loc = [0 0 -30];                           % PTO Location [m]


pto(2) = ptoClass('PTO2');                      % Initialize PTO Class for PTO1
pto(2).k = 0;                                   % PTO Stiffness [N/m]
pto(2).c = 1200000;                             % PTO Damping [N/(m/s)]
pto(2).loc = [0 0 -6];                           % PTO Location [m]
